...
@implementation PasswordTextFieldDesignable
...
- (void)drawRect:(CGRect)rect {
    ...
    NSAttributedString * stremail = [[NSAttributedString alloc] initWithString:@"Password" attributes:@{ NSForegroundColorAttributeName : [UIColor colorWithRed:255.0/255.0 green:83.0/255.0 blue:31.0/255.0 alpha:1.0],NSFontAttributeName:[UIFont systemFontOfSize:15.0] }];
