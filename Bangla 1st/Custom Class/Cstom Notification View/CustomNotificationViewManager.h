//
//  CustomNotificationViewManager.h
//
 ...
 */
typedef NS_ENUM(NSInteger, CustomNotificationViewMessageType) {
    CustomNotificationViewMessage,
   // CustomNotificationViewMessageTypeSuccess,
   // CustomNotificationViewMessageTypeInfo
};

@protocol CustomNotificationViewStyleSheet <NSObject>
 ...
 */
- (nonnull UIFont *)titleFontForMessageType:(CustomNotificationViewMessageType)type;
 ...
 */
- (nonnull UIFont *)descriptionFontForMessageType:(CustomNotificationViewMessageType)type;
 ...
 */
- (nonnull UIColor *)titleColorForMessageType:(CustomNotificationViewMessageType)type;
 ...
 */
- (nonnull UIColor *)descriptionColorForMessageType:(CustomNotificationViewMessageType)type;

@end

@interface CustomNotificationViewManager : NSObject
...
/**
 *  An object conforming to the CustomNotificationViewStyleSheet protocol defines the message bar's look and feel.
 *  If no style sheet is supplied, a default class is provided on initialization (see implementation for details).
 */
@property (nonnull, nonatomic, strong) NSObject<CustomNotificationViewStyleSheet> *styleSheet;
